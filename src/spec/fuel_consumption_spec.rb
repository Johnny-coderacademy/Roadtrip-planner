...
describe "Car" do 
    ...
    it "should return expected string for show_fuel_consumption method " do
        expected = "The fuel consumption of your selected vehicle - car is 0.3 ltr/100km"
...
describe "Motorbike" do
    ...
    it "should return expected string for show_fuel_consumption method " do
        expected = "The fuel consumption of your selected vehicle - motorbike is 0.1 ltr/100km"
